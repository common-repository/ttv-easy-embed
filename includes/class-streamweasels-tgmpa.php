...
class TGM_Plugin_Activation_SwtiRail {
	function swti_register_required_plugins() {
		...
		*/
		$config = array(
			...
			'has_notices'  => true,
			'dismissable'  => false,
			'dismiss_msg'  => 'Twitch Rail has a new home! Please install <strong>StreamWeasels Twitch Integration</strong> instead.',
			'is_automatic' => true,
